$(document).ready(function() {
    ...
    // Function to initialize event handlers for a form row
    function initializeFormEvents(formRow) {
        ...
        const unitCostInput = formRow.find('.unit-cost');
        const totalCostInput = formRow.find('.total-cost');
        const availableStockInput = formRow.find('.available-stock');
            ...
            if (itemId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        availableStockInput.val(data.available_stock);
    ...
    $('.item-form').each(function() {
        ...
        if (row.find('input[id$="-id"]').val()) {
            ...
            deleteCheckbox.hide();
            deleteCheckbox.next('label').hide();
            
            // Add a delete button instead
            const deleteButton = $('<button type="button" class="btn btn-sm btn-danger delete-item"><i class="bi bi-trash"></i> Remove</button>');
